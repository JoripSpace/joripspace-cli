...
Usage:
  ...
  joripspace github prepare --project PROJECT --cwd PATH [--entrypoint worker.js]
  ...
  joripspace report --project PROJECT --category bug --summary "문제 요약" [--details TEXT] [--expected TEXT] [--actual TEXT] [--error-code CODE]
